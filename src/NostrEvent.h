...
namespace nostr {
    ...
    class NostrEventTags {
       public:
         ...
         */
        unsigned int addTag(NostrString key,
    ...
    class NostrEvent {
       ...
       protected:
        ...
        NostrString content;
        NostrEvent(unsigned int kind, NostrEventTags tags, NostrString content,
                   unsigned long int created_at)
            : kind(kind),
              tags(tags),
              content(content),
    ...
    class UnsignedNostrEvent : public NostrEvent {
       public:
        ...
        UnsignedNostrEvent(unsigned int kind, NostrString content,
                           unsigned long int created_at)
            : NostrEvent(kind, NostrEventTags(), content, created_at){};
    ...
    class SignedNostrEvent : public NostrEvent {
       ...
       protected:
        ...
        SignedNostrEvent(NostrString id, NostrString pubkey, unsigned long int created_at,
                         unsigned int kind, NostrEventTags tags, NostrString content,
                         NostrString signature)
            : NostrEvent(kind, tags, content, created_at),
              id(id),
              pubkey(pubkey),
              signature(signature),
              stored(false){};
