...
class Utils {
  public:
    ...
    static size_t fromHex(const char *hex, size_t hexLen, uint8_t *array, size_t arraySize);
    static NostrString toHex(const uint8_t *array, size_t arraySize);
    static NostrString hexToBase64(NostrString hex);
    static size_t hexToBytes(NostrString hex, uint8_t *output, size_t outputSize);
